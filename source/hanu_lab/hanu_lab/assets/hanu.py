...
"""Configuration for the Hanumanoid A4 robot for implicit actuator"""

HANU_A4_EXPLICIT_CFG = ArticulationCfg(
    prim_path="{ENV_REGEX_NS}/hanu_a4",
    spawn=sim_util.UsdFileCfg(
        usd_path=f"{HANU_LAB_EXT_DIR}/hanu_lab/data/Robots/hanu/hanu_a4_description/urdf/hanu_a4/hanu_a4_v1.usd", 
        activate_contact_sensors=True,
...
"""Configuration for the Hanumanoid A4 robot for explicit actuator"""