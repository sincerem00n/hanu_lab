...
from .hanu_lab_marl_env_cfg import HanuLabMarlEnvCfg


class HanuLabMarlEnv(DirectMARLEnv):
    cfg: HanuLabMarlEnvCfg

    def __init__(self, cfg: HanuLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
