...
from .rough_env_cfg import HanumanoidA0RoughEnvCfg, HanuRewardsCfg


@configclass
class HanumanoidA0FlatEnvCfg(HanumanoidA0RoughEnvCfg):
...
class HanumanoidA0FlatEnvCfg_PLAY(HanumanoidA0FlatEnvCfg):
